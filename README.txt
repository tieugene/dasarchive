0.0.2 - Работает, фильтры OK. Но inbox - webdav, поэтому надо ставить в корень.
0.0.3 будет: 1) inbox == папка, 2) мы будем сидеть в VirtualFolder, 3) WebDAV обрабатывается wdp
